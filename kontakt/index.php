<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../login.php?redirect=kontakt/index.php");
	}
?>
...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="prev" href="../extensions/permalinks/">
      ...
      <meta name="generator" content="mkdocs-1.4.3, mkdocs-material-9.1.15">
        ...
        <title>Kontakt - MaaS NRW Wiki - Demo Site</title>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <a href="https://github.com/PartTimeDataScientist/mkdocs-wiki-test/edit/master/docs/kontakt.md" title="Edit this page" class="md-content__button md-icon">
      ...
      <div class="md-feedback__inner">
        ...
        <div class="md-feedback__note">
            ...
            <div data-md-value="0" hidden>
              ...
              Danke für das Feedback! <a href="https://github.com/PartTimeDataScientist/mkdocs-wiki-test/issues/new/?title=[Feedback]+-+Kontakt+-+/kontakt/" target="_blank">Sag uns gerne, was wir verbessern können!</a>
            </div>
