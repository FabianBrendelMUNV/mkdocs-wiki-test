<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=extensions/metadata/index.php");
	}
?>
...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.4.3, mkdocs-material-9.1.15">
        ...
        <title>Metadaten - MaaS NRW Wiki - Demo Site</title>
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#overriding-the-title" class="md-nav__link">
    Overriding the title
          ...
          <li class="md-nav__item">
  <a href="#overriding-the-description" class="md-nav__link">
    Overriding the description
          ...
          <li class="md-nav__item">
  <a href="#linking-sources" class="md-nav__link">
    Linking sources
  </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#linking-sources" class="md-nav__link">
    ...
    <a href="https://github.com/PartTimeDataScientist/mkdocs-wiki-test/edit/master/docs/extensions/metadata.md" title="Edit this page" class="md-content__button md-icon">
...
<p>The <a href="https://pythonhosted.org/Markdown/extensions/meta_data.php">Metadata</a> extension makes it possible to add metadata to a document
...
<p>Example:</p>
<div class="highlight"><pre><span></span><code>title: Lorem ipsum dolor sit amet
description: Nullam urna elit, malesuada eget finibus ut, ac tortor.
path: path/to/file
source: file.js

<span class="gh"># Headline</span>

...
</code></pre></div>
<p>See the next section which covers the metadata that is supported by Material.</p>
<h3 id="overriding-the-title">Overriding the title<a class="headerlink" href="#overriding-the-title" title="Permanent link">#</a></h3>
...
title.</p>
<h3 id="overriding-the-description">Overriding the description<a class="headerlink" href="#overriding-the-description" title="Permanent link">#</a></h3>
<p>The page description can also be overridden on a per-document level:</p>
<div class="highlight"><pre><span></span><code><span class="nt">description</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">Nullam urna elit, malesuada eget finibus ut, ac tortor.</span>
</code></pre></div>
...
<h3 id="linking-sources">Linking sources<a class="headerlink" href="#linking-sources" title="Permanent link">#</a></h3>
<p>When a document is related to a specific set of source files and the <code>repo_url</code>
is defined inside the project&rsquo;s <code>mkdocs.yml</code>, the files can be linked using the
<code>source</code> key:</p>
<div class="highlight"><pre><span></span><code>source: file.js
</code></pre></div>
...
<p>Example:</p>
<div class="highlight"><pre><span></span><code>path: tree/master/docs/extensions
source: metadata.md
</code></pre></div>
<p>Result:</p>
      ...
      <div class="md-feedback__inner">
        ...
        <div class="md-feedback__note">
            ...
            <div data-md-value="0" hidden>
              ...
              Danke für das Feedback! <a href="https://github.com/PartTimeDataScientist/mkdocs-wiki-test/issues/new/?title=[Feedback]+-+Metadaten+-+/extensions/metadata/" target="_blank">Sag uns gerne, was wir verbessern können!</a>
            </div>
